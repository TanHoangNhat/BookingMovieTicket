      ...
      <div className={s.footer__wrapper}>
        <div className={s.footer__content}>
          <div className={`row m-0 ${s.footer__info}`}>
            <div
              className={`${s.info__item} ${s.left} text-center text-sm-start col-12 col-sm-4 pb-5`}
            >
            ...
            <div
              className={`${s.info__item} ${s.middle} text-center text-sm-start col-12 col-sm-4 pb-5`}
            >
            ...
            >
              <div className="col-6 mb-3 m-0">
                <h4 className="col-12 m-0 text-white text-center">
                  MOBILE APP
                </h4>
